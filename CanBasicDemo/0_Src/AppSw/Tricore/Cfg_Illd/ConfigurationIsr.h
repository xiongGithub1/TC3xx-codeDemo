 ...
 *
 * \defgroup IfxLld_Demo_CanBssic_SrcDoc_InterruptConfig Interrupt configuration
 * \ingroup IfxLld_Demo_CanBssic_SrcDoc
 */
...
/**
 * \addtogroup IfxLld_Demo_CanBssic_SrcDoc_InterruptConfig
 * \{ */
