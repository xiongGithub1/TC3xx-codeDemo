 ...
 * \{ */
#define ISR_PROVIDER_PRINTF_ASC0 IfxSrc_Tos_cpu0          /**< \brief Define the ASC0 interrupt provider.  */
 ...
 * \{ */
#define INTERRUPT_PRINTF_ASC0_TX    ISR_ASSIGN(ISR_PRIORITY_PRINTF_ASC0_TX, ISR_PROVIDER_PRINTF_ASC0)           /**< \brief Define the ASC0 transmit interrupt priority.  */
#define INTERRUPT_PRINTF_ASC0_EX    ISR_ASSIGN(ISR_PRIORITY_PRINTF_ASC0_EX, ISR_PROVIDER_PRINTF_ASC0)           /**< \brief Define the ASC0 error interrupt priority.  */
