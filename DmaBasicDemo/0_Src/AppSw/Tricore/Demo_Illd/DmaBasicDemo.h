...
IFX_EXTERN volatile uint32 IFX_ALIGN(64) source[NUM_CHANNELS][BUFFER_SIZE]; /**< \brief source buffer */ 
IFX_EXTERN volatile uint32 IFX_ALIGN(64) destination[NUM_CHANNELS][BUFFER_SIZE]; /**< \brief destination buffer */
