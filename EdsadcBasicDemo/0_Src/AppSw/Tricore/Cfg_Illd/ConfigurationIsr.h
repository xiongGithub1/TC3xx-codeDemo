 ...
 *
 * \defgroup IfxLld_Demo_EdsadcBasicDemo_SrcDoc_InterruptConfig Interrupt configuration
 * \ingroup IfxLld_Demo_EdasdcBasicDemo_SrcDoc
 */
...
/**
 * \addtogroup IfxLld_Demo_EdsadcBasicDemo_SrcDoc_InterruptConfig
 * \{ */
