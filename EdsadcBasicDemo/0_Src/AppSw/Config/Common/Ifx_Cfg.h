 ...
 *
 *
 * \defgroup IfxLld_Demo_EdsadcBasicDemo_SrcDoc_IlldConfig iLLD configuration
 * \ingroup IfxLld_Demo_EdsadcBasicDemo_SrcDoc
 */
...
/** \addtogroup IfxLld_Demo_EdsadcBasicDemo_SrcDoc_IlldConfig
 * \{ */
