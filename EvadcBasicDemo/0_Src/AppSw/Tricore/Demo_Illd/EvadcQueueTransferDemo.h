...
#ifndef EVADCQUEUETRANSFERDEMO_H
#define EVADCQUEUETRANSFERDEMO_H 1
...
/*------------------------------Global variables------------------------------*/
/******************************************************************************/
IFX_EXTERN App_EvadcQueueTransfer g_EvadcQueueTransfer;

/******************************************************************************/
/*-------------------------Function Prototypes--------------------------------*/
/******************************************************************************/
IFX_EXTERN void EvadcQueueTransferDemo_init(void);
IFX_EXTERN void EvadcQueueTransferDemo_run(void);
