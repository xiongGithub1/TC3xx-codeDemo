 ...
 *
 * \defgroup IfxLld_Demo_EvadcBasicDemo_SrcDoc_InterruptConfig Interrupt configuration
 * \ingroup IfxLld_Demo_EvadcBasicDemo_SrcDoc
 */
...
/**
 * \addtogroup IfxLld_Demo_EvadcBasicDemo_SrcDoc_InterruptConfig
 * \{ */
