...
typedef struct
{
    ...
    uint8 IFX_ALIGN(64) spi0TxBuffer[SPI_BUFFER_SIZE];                               /**< \brief Qspi0 Transmit buffer */
    uint8 IFX_ALIGN(64) spi0RxBuffer[SPI_BUFFER_SIZE];                               /**< \brief Qspi0 receive buffer */
    uint8 IFX_ALIGN(64) spi2TxBuffer[SPI_BUFFER_SIZE];                               /**< \brief Qspi2 Transmit buffer */
    uint8 IFX_ALIGN(64) spi2RxBuffer[SPI_BUFFER_SIZE];                               /**< \brief Qspi2 receive buffer */
